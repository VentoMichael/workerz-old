            ...
            <form class="show-content form-login form-register form-message"
                ...
                <div class="container-register-form">
                    <div class="container-form-email">
                        ...
                        <input type="text" id="name" @if(\Illuminate\Support\Facades\Auth::check()) value="{{\Illuminate\Support\Facades\Auth::user()->name}}" @else value="{{ old('name') }}" @endif placeholder="Rotis" class=" @error('name') is-invalid @enderror email-label" name="name" required aria-required="true">
                    </div>
                    <div class="container-form-email">
                ...
                <div class="container-register-form">
                    <div class="container-form-email">
                        ...
                        <input id="email" type="email"
                               ...
                               name="email"
                               value="@if(\Illuminate\Support\Facades\Auth::check()) {{\Illuminate\Support\Facades\Auth::user()->email}} @else {{ old('email') }} @endif" placeholder="danielrotis@gmail.com" required aria-required="true" autocomplete="email">
                        @error('email')
                ...
                <span role="alert" class="error">
                    ...
                    <div class="container-form-email">
                        ...
                        <input type="text" placeholder="Engagez un menuisier" id="subject" value="{{old("subject")}}" class=" @error('subject') is-invalid @enderror email-label" name="subject" required aria-required="true">
                    </div>
                </div>

                <div class="container-register-form container-textarea">
                    <div class="container-form-email">
                        <label for="message">Message <span class="required aria-required="true"">*</span></label>
