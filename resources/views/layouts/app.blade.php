...
<header>
    <div class="mobile-menu__container">
        <ul class="menu menuId mobile-menu__list" id="menu">
            <li>
                <a href="#">
                    <svg version="1.1" id="Calque_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 162.5 33.2" style="enable-background:new 0 0 162.5 33.2;" xml:space="preserve" width="162.5" height="33.20000076293945">
<style type="text/css">
...
<footer>
    ...
    <section>
        <h3 aria-level="3" class="hiddenTitle">
    ...
    <a href="/">
        <img class="logoFooter" src="{{ asset('svg/logo.svg') }}" alt="Redirection vers la page d'acceuil">
    </a>
</footer>
@yield('scripts')
</body>
