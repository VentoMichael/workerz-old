<div>
    <form class="form-login form-register @if(auth()->user())form-edit @endif" enctype="multipart/form-data"
        ...
        <div
            class="container-register-form container-register @if(auth()->user()) container-edition-formulary @endif">
            ...
            <div class="container-register-form container-register @if(auth()->user()) container-edit-formulary @endif">
                ...
                <div
                    class="container-form-email container-register @if(auth()->user()) container-edit-formulary @endif container-job-profil selectdiv container-cat">
                    @endif
