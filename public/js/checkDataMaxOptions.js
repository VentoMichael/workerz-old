...
/*!*********************************************!*\
  !*** ./resources/js/checkDataMaxOptions.js ***!
  \*********************************************/
for (var checksCat = document.querySelectorAll(".checkCat"), maxCat = 1, i = 0; i < checksCat.length; i++) {
  checksCat[i].onclick = selectiveCheckCat;
}

function selectiveCheckCat(e) {
  if (document.querySelectorAll(".checkCat:checked").length >= maxCat + 1) return alert("Uniquement 1 catégorie est possible."), !1;
}
