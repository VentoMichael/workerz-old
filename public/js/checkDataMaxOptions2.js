...
/*!**********************************************!*\
  !*** ./resources/js/checkDataMaxOptions2.js ***!
  \**********************************************/
for (var checksCat = document.querySelectorAll(".checkCat"), maxCat = 2, i = 0; i < checksCat.length; i++) {
  checksCat[i].onclick = selectiveCheckCat;
}

function selectiveCheckCat(e) {
  if (document.querySelectorAll(".checkCat:checked").length >= maxCat + 1) return alert("Uniquement 2 catégories sont possible."), !1;
}
